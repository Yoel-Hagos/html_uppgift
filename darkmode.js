...
function enableDarkMode() {
  ...
  //themeImage.src = 'dark-image.jpg'; För att ändra på bilden//
  themeImage.src = 'silicon_dark.svg';
}
function disableDarkMode() {
  darkmodeSwitch.checked = false
  document.documentElement.classList.remove('dark')

    //themeImage.src = 'light-image.jpg'; För att ändra på bilden//
    themeImage.src = 'silicon_light.svg';
